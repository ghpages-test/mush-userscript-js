...
exportFunction(Main.AstroPad.updateInventory, window.Main.AstroPad, { defineAs: 'updateInventory' });
...
exportFunction(Main.AstroPad.getLocalData, window.Main.AstroPad, { defineAs: 'getLocalData' });
...
Main.AstroPad.setChatBlock = function () {
    ...
    $('#chatBlock').on('scroll', function () { //Does not overwrite the 'onscroll' attr.
        if (window.Main.lmwProcessing) {
            var chatloading = window.setInterval(function () {
                if (!window.Main.lmwProcessing) { //Detect end of loading
...
exportFunction(Main.AstroPad.joinPad, window.Main.AstroPad, { defineAs: 'joinPad' });
